/*
 * $Source: /project/arl/arlcvs/cvsroot/wu_arl/openNetLab/proxy/control.h,v $
 * $Author: fredk $
...
namespace wuctl {
  ...
  class sessionCmd {
    public:
      ...
      static const cmd_type cmdEOF        = 7; // session closed pipe/exiting
      static const cmd_type cmdCount      = 8;
