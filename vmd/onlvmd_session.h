...
#ifndef _ONLVMD_SESSION_H
#define _ONLVMD_SESSION_H
...
namespace onlvmd
{
  ...
  class session
  {
    ...
    public:
      ...
      vm_ptr addVM(component& c, std::string eaddr, uint32_t crs, uint32_t mem, std::string pw, std::string nm);
