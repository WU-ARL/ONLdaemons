...
echo "ip route add ${PREFIX}/${MASK} dev data0.${VLAN_laptop} via ${IP_DATA_NEXT_HOP}  table ${ROUTING_TABLE_ID}"
ip route add ${PREFIX}/${MASK} dev data0.${VLAN_laptop} via ${IP_DATA_NEXT_HOP}  table ${ROUTING_TABLE_ID}
